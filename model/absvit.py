...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x, return_all_features=False, prompt_=None, clip_mask=None):
        input = x
        output_each_iter = []
...
@register_model
def absvit_tiny_patch16_224(pretrained=False, pretrained_cfg=None, **kwargs):
    model = VisionTransformer(
        patch_size=16, embed_dim=144, text_dim=144, depth=8, num_heads=3, mlp_ratio=4, qkv_bias=True,
